...
\item {\it If we told you that that the sensors are located as in \ref{fig:sensor_locations}, hypothesize which location would you assign to each sensor and reason your hypothesis using the correlations.}
